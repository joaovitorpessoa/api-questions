...
var CreateQuestionUseCase = /** @class */ (function () {
    ...
    CreateQuestionUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var questionAlreadyExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.questionsRepository.findByTitle(title)];
                    case 1:
                        questionAlreadyExists = _b.sent();
                        if (questionAlreadyExists) {
                            throw new errors_1.AppError("Question already exists!");
                        }
                        return [4 /*yield*/, this.questionsRepository.create({ title: title, description: description })];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
